...
1. **Shared `build_into` → isolate with worktrees, don't serialize.**
   ...
   fastembed) are memory-hungry; 5 bounds the blast radius (raised 3 → 5 by user 2026-09-09, briefly 8, reverted after the 8-wide tick made the box unresponsive: RedBaron 30 GB, worktree targets on /mnt/data). Kernel-extend
